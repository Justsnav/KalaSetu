...
const AuthPage = () => {
    ...
    // Get the role selected from Landing Page
                ...
                <div className="relative z-10 w-full max-w-[460px]">
                    ...
                    <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] p-6 shadow-2xl backdrop-blur-xl md:p-8">
                                ...
                                <button
                                    ...
                                    className={`flex items-center justify-center gap-2 rounded-lg border px-4 py-3 text-sm transition-all ${
                                        role === "buyer"
                                            ...
                                            : "border-white/[0.08] bg-white/[0.02] text-[#8d8177] hover:border-white/20 hover:text-[#c8bfb6]"
                                    }`}
                                >
                                    <ShoppingBag size={17} />
                                    Buyer
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#d4af37] py-3.5 text-sm font-semibold text-[#1c1713] transition hover:bg-[#e7c85c] hover:shadow-[0_0_25px_rgba(212,175,55,0.15)]"
                            >
                                {isLogin
                                    ? "Login"
                                    : `Create ${role === "artisan" ? "Artisan" : "Buyer"} Account`
                                }
                    ...
                    <p className="mt-6 text-center text-[11px] text-[#625950]">
                        By continuing, you agree to KalaSetu's Terms of Service
                        and Privacy Policy.
                    </p>
